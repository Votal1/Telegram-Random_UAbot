...
def quests(uid):
    ...
    q31t = [0, 1, 1, 1]
    q31p = ['', '\U0001F9F0 Купити і випити 50 горілки', '\U0001F6AC Взяти участь у битві в темному провулку',
    ...
    q32 = ['', '\U0001F3DF Перемогти в міжчатовій битві 5 разів', '\U0001F35C Погодувати русака',
           '\U0001F3C6 Почати дуель, маючи 10000 бойового духу']
    q32t = [0, 5, 1, 1]
    ...
    q33 = ['', '\U0001F469\U0001F3FB Купити батіг або жінку', '\U0001F4B0 Набрати 100000 сили в рейді',
           '\U0001F69B Пограбувати гумконвой']
    q33t = [0, 1, 1, 1]
    q33p = ['', '\U0001F919 Провести 30 боїв проти ворога без зброї', '\U0001F52E Отримати шизофренію від фокусів',
            '\U0001F921 Стати свідком вбивства малороса']
    q33pt = [0, 30, 1, 1]

    q34 = ['', '\U0001F4B5 Знайти гроші в пакунку', '\U0001F9C2 Купити силу на сольовому ринку',
           '\U0001F9EA Купити собі щось в торговому центрі або на невільничому ринку']
    q34t = [0, 1, 1, 1]
    q34p = ['', '\u26D1 Змешити здоров`я до 0 в дуелях', '\U0001F695 Однією дією отримати 20 донбаських пакунків',
            '\U0001F4DF Виграти в дуелі так, щоб ворог отримав 10 гривень']
    q34pt = [0, 1, 1, 1]
