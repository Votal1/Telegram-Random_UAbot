...
def quests(uid):
    ...
    q34 = ['', '\U0001F4B5 Знайти гроші в пакунку', '\U0001F9C2 Купити силу на сольовому ринку',
           '\U0001F9EA Купити щось в торговому центрі або на невільничому ринку']
    q34t = [0, 1, 1, 1]
    q34p = ['', '\u26D1 Зменшити здоров`я до 0 в дуелях', '\U0001F695 Однією дією отримати 20 донбаських пакунків',
