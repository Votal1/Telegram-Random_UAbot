...
def merchant_msg():
    ...
    if slot1 == 3:
        msg += '\U0001F6A7 Міни [Захист, міцність=3, ціна=30] - з шансом 33% завдає ворогу 5 поранень і ' \
               'зменшує міцність зброї на 5. Можливість використати міни при захисті клану. Бронежилет захищає від мін.'
    ...
    msg += '\n\n\U0001F919 Травмат [Зброя, міцність=5, ціна=6] - зменшує силу ворога на бій на 50%.\n' \
           ...
           '\u26D1 Медична пилка [Зброя, міцність=8, ціна=10] - якщо у ворога нема поранень - завдає 1, якщо більше ' \
