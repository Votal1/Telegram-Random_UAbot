...
def shop_msg(uid, mode):
    ...
    if mode == 1:
        ...
        msg = f'\U0001F4B5 Гривні: {money}\n\nОсь опис товарів, які можна придбати:\n\n\u2622 Горілка "Козаки" - ' \
              f'збільшує русаку бойовий дух на 10-70.\n\U0001F5E1 Колючий дрин [Зброя]- зменшує перед боєм ' \
              ...
              f'\U0001F4B3 Трофейний паспорт - поміняє ім`я ' \
        ...
        msg = f'\U0001F31F Погони російських генералів: {strap}\n\nОсь опис товарів, які можна придбати:\n\n' \
              ...
              f'та шизи. Якщо в русака менше ніж 4000 сили - можна погодувати ще раз.\n' \
