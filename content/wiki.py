...
def wiki_text(data):
    ...
    if data == 'wiki_menu':
        ...
        msg = '\U0001F6E1 Список захисного спорядження\n\n' \
              ...
              '\U0001f535 Сюртук [міцність=7] - збільшує зарплату в 3 рази (в 5 разів, якщо є Telegram Premium). ' \
              'Отримується за інвестицію від 1000 гривень (необхідний вільний слот захисту).\n\n' \
