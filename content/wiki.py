...
def wiki_text(data):
    ...
    if data == 'wiki_menu':
        ...
        msg = '\U0001F4C8 Розвиток\n\nУ русака є дві основні характеристики - \U0001F4AA сила та \U0001F9E0 інтелект.' \
              ...
              'купити утеплену будку, яка збільшуватиме силу на 15 до 5000 сили. Якщо в русака від 5000 сили, то вона' \
              ' може зменшитись з шансом 20%, а якщо більше 8000 - 40%. Також є 20% шанс шо русак захворіє і нічо не ' \
        ...
        msg = '\U0001F9F3 Список двічі покращеного класового спорядження\n\n' \
              ...
              'на 20%. 66% шанс не зменшити міцність в дуелях. При перемозі збільшує міцність на 3 (максимум 100).\n\n'\
              ...
              'Black Hat може отримати до 10 гривень. При невдалій зміні на шахтах - отримує інформацію про прибуття' \
              ' торговця. Шанс, який дорівнює інтелекту, отримати інформацію про прибуття гумконвою, ставши на ' \
              'охорону.\n\n' \
