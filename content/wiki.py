...
def wiki_text(data):
    ...
    if data == 'wiki_menu':
        ...
        msg = '\U0001f7e9 Асоціація\n' \
              ...
              '1 пакунок за кожні 20000 сили.' \
              '\n\nІнфраструктура:\n' \
              'Dungeon - можливість купувати батіг (+30% сили рейдової групи проти клану, якщо в русака нема жінки).\n'\
        ...
        msg = '\U0001F9F3 Список класового спорядження та додаткові ефекти від їхніх покращених версій\n\n' \
              ...
              '\U0001F695 Дизель [Допомога, міцність=5] - збільшує власну силу в масових битвах та міжчатових битвах ' \
              'на 25%.\n' \
              '\u2B06\uFE0F Ракетне паливо - збільшує силу в рейдах на 25%.\n' \
        ...
        msg = '\U0001F5E1 Список зброї\n\n' \
              ...
              '\U0001f7e3 Батіг [міцність=3] - збільшує силу рейдової групи проти клану на 30%, якщо в русака нема' \
              ' жінки. Доступно для покупки в Асоціації.\n' \
