...
def wiki_text(data):
    ...
    if data == 'wiki_menu':
        ...
        msg = '\U0001F9F3 Список класового спорядження та додаткові ефекти від їхніх покращених версій\n\n' \
              ...
              '\u2B06\uFE0F Zeus X27 [Зброя, міцність=1] - зменшує здоров\'я ворога в дуелі до 0.\n' \
              '\U0001F46E Поліцейський щит [Захист, міцність=10] - зменшує силу ворога на 20% як і в захисті, ' \
              'так і в атаці.\n' \
              '\u2B06\uFE0F Важкий поліцейський щит - захищає від РПГ-7, зменшуючи свою міцність на 50% + 5.\n' \
              ...
              '\u2B06\uFE0F Ампутатор - лікує 15 поранень або шизофренії та здоров`я.\n' \
              ...
              'на 20%.\n' \
              '\u2B06\uFE0F Дизель - збільшує власну силу в рейдах на 20%.\n' \
              '\U0001F396 Палаш [Зброя, міцність=15] - +100% сили проти русаків без клану, +25% в іншому випадку.\n' \
              '\u2B06\uFE0F Золотий палаш - додаткові +100% сили проти тих, хто не має погонів ' \
              'російських генералів, +25% проти тих, хто має.'
