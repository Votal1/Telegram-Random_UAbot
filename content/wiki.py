...
def wiki_text(data):
    ...
    if data == 'wiki_menu':
        ...
        msg = '\U0001f7e9 Асоціація\n' \
              ...
              '\n\nІнфраструктура:\n' \
              'Dungeon - можливість купувати батіг (+30% сили рейдової групи, якщо в русака нема жінки).\n' \
        ...
        msg = '\U0001F5E1 Список зброї\n\n' \
              ...
              '\U0001f7e3 Батіг [міцність=3] - збільшує силу рейдової групи на 30%, якщо в русака нема жінки. ' \
