...
def wiki_text(data):
    ...
    if data == 'wiki_menu':
        ...
        msg = '\u2694\uFE0F Існує 4 типи боїв:\n\n\U0001F5E1 Дуелі - проводяться за викликом бота в інлайн режимі. ' \
              ...
              '\U0001fac0 Здоров`я - параметр, необхідний для всіх типів боїв. Якщо здоров`я більше 90 - сила ' \
              'збільшиться на 10%, якщо менше 10 - сила зменшиться до 10%, якщо 0 - потрібно лікування або годування.'
        ...
        msg = '[beta]\n\n🧌 Комплекти - набір з 4 елементів спорядження, який активує додаткові ефекти.\n\n' \
              ...
              '+15% шанс почати рейд знову після невдачі або магазину алкоголю.\n\n' \
              ...
              '10% шанс провести рейд на Соледар, замість клану.\n\n' \
