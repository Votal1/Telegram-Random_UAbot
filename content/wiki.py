...
def wiki_text(data):
    ...
    if data == 'wiki_menu':
        ...
        msg = '\U0001F4B0 Рейди\n\nМожна проводити, починаючи з будь-якого рівня, але зарейдити можуть тільки, якщо ' \
              ...
              'Макіївка - ВСС / Контакт-1 / підсумок / тактичний шолом / рускій дух\n' \
        ...
        msg = '\U0001faac Бафи - тимчасові бонуси, які діють протягом однієї кланової війни. Майже всі бафи можна ' \
              ...
              'Коаліція:\n' \
              '\U0001f7e3\U0001f7e3 2% шанс непомітно отримати квестове очко за перемогу в дуелі.\n' \
              '\U0001f7e3\U0001f7e3\U0001f7e3 +12 квестових очків за охорону території, якщо увімкнена зарплата.\n' \
              'Асоціація:\n' \
        ...
        msg = '\U0001f7e5 Комуна\n' \
              ...
              '\U0001f7e5 Союз\n' \
              'Можливість виготовити всьому клану по Кожуху та видати Мосінку (10 міцності). ' \
        ...
        msg = '\U0001F9F3 Інвентар (/i) вміщує спорядження чотирьох типів - Зброя, Захист, Допомога та Шапка. ' \
              ...
              'момент замінити його на наявне або перекинути на іншого русака. В рюкзаку можна зберігати навіть ' \
              'класове спорядження, але забрати його може тільки русак потрібного класу. Міцність одинакових ' \
              'предметів не сумується. Спочатку туди можна покласти один предмет, але можна купити місце для ' \
              'більшої кількості. Рюкзак можна розширити до 5 слотів: в магазині за 5/10/15/20 погонів або в ' \
              'мандрівного торговця за 20-50/40-100/80-200/160-400 ізострічки і 1-3 погона.\n\n' \
        ...
        markup.add(InlineKeyboardButton(text='\U0001F9EA Допомога', callback_data='wiki_weapons_3'),
                   InlineKeyboardButton(text='\U0001F3A9 Шапка', callback_data='wiki_weapons_4'))
        msg = '🧌 Комплекти - набір з 4 елементів спорядження, який активує додаткові ефекти.\n\n' \
              ...
              'Купуючи ярмулку за погон, міцність всього комплекту збільшиться на 7 (максимум 30). ' \
              ...
              '+20% шанс потрапити на тематичну рейдову локацію. ' \
              'Русаки без протигазу отримають +10 поранення та шизофренії.\n\n' \
              '🗡 ВСС / В\'язанка болтів / Аномальна сокира Перуна / Бойовий ніж\n' \
              '🛡 Екзоскелет\n' \
              '🧪 Артефакт\n' \
              '🎩 Протигаз\n\n' \
              '🧿 Містичний комплект\n\n' \
              'Можливість ввести промокод. Як його знайти? Ніяк, думайте, вгадуйте.\n\n' \
              '🗡 Скринька Пандори / Зачароване незеритове кайло / Колесо Фортуни\n' \
              '🛡 Контакт-1\n' \
              '🧪 Швайнокарась / Повістка\n' \
              '🎩 Кавун базований'
        ...
        msg = '\U0001F5E1 Список зброї\n\n' \
              ...
              '\U0001f535 SuperCum S350 - покращений БпЛА. За кожен рівень майстерності (/skills) збільшує силу в ' \
              'масовій битві на 50% та збільшує шанс не втратити зброю на 18%. Завдає +1-5 поранень ворожим ' \
              'охоронцям при рейді на клан.\n\n' \
              '\U0001f7e3 Батіг [міцність=3] - +15% сили в рейді, +33% якщо в русака нема жінки.' \
              ' Доступно для покупки в Асоціації та у мандрівного торговця.\n\n' \
              '\U0001f7e3 В\'язанка болтів - покращений батіг. Окрім старих здібностей, дозволяє гарантовано' \
              ' отримати артефакт з битви на аномальному полі.\n\n' \
              '\U0001f7e3 Саквояж [міцність=7] - гарантовані +3 солі за щоденну гру у @wordle1bot. ' \
              'Можна отримати за рейд на синагогу.\n\n' \
              '\U0001f7e3 ВСС [міцність=20] - +50% сили в масовій битві та ухилення від негативних ефектів у ' \
              'масових і міжчатових битвах та рейдах.\n\n' \
        ...
        msg = '\U0001F6E1 Список захисного спорядження\n\n' \
              ...
              '4 гривні. Можна знайти в пакунку або купити на тракторному заводі.\n\n' \
              ...
              '\U0001f7e3 Контакт-1 [міцність=1] - змінює дію ворожого РПГ - завдає 300 поранень вам і собі.\n\n' \
              '\U0001f7e3 Екзоскелет - покращений уламок бронетехніки. ' \
              'Збільшує силу в дуелі на 120% під час захисту, але зменшує на 20% під час атаки.\n\n' \
        ...
        msg = '\U0001F9EA Список допоміжного спорядження\n\n' \
              ...
              '\U0001f535 Артефакт Пузир - лікує поранення і шизофренію в дуелях на 1.' \
              ' Можна знайти на аномальному полі.\n\n' \
              '\U0001f535 Артефакт Світляк - лікує 6 поранення, але додає 3 шизофренії в дуелях.' \
              ' Можна знайти на аномальному полі.\n\n' \
              '\U0001f535 Артефакт Сніжинка - лікує здоров\'я до максимуму, але додає 1 поранення і шизофренію.' \
              ' Можна знайти на аномальному полі.\n\n' \
              '\U0001f535 Артефакт Золота рибка - збільшує нагороду в дуелях на 50%.' \
              ' Можна знайти на аномальному полі.\n\n' \
              ...
              '\U0001f7e1 Артефакт Серце Оази - лікує поранення і шизофренію в дуелях на 1, зникає лише при годуванні' \
              ' - в такому разу гарантує збільшення сили (на втричі більше значення). Можна знайти в' \
              ' рейді на сталкерську локацію.\n\n' \
        ...
        msg = '\U0001F3A9 Список шапок\n\n' \
              ...
              'При купівлі в Ордені русак отримує 30 шизофренії, а при отриманні з пакунків - 10.\n\n' \
