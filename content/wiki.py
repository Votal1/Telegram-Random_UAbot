...
def wiki_text(data):
    ...
    if data == 'wiki_menu':
        ...
        msg = '\U0001F9F3 Інвентар (/i) вміщує спорядження чотирьох типів - Зброя, Захист, Допомога та Шапка. ' \
              ...
              'більшої кількості. Рюкзак можна розширити до 5 слотів: в магазині за 5/10/20 погонів або в мандрівного '\
              'торговця за 20-50/40-100/80-200 ізострічки і 1-3 погона.\n\n' \
