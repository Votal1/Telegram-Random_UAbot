...
def wiki_text(data):
    ...
    if data.startswith('wiki_chances'):
        ...
        msg = '\U0001F523 Шанси\n\nДуелі:\n' \
              ...
              '\U0001F44A Бойовий транс - збільшує силу на 20% та бойовий дух - на 80%.'
    if data.startswith('wiki_raid'):
        ...
        msg = '\U0001F4B0 Рейди\n\nМожна проводити, починаючи з будь-якого рівня, але зарейдити можуть тільки, якщо ' \
              ...
              'Відділення монобанку - ???\n' \
              'Магазин алкоголю - горілка, здоров`я, бойовий дух\n' \
              'АТБ - 40% - гроші, 30% - цукор, 20% - кавувн, 10% - годування\n' \
              'Сільпо - 40% - гроші, по 20% - цукор, кавувн або годування\n' \
              'Епіцентр - ресурси\n\n' \
              ...
              'повне розграбування - 20 пакунків і партія ресурсів в магазин.\n\n' \
    ...
    if data.startswith('wiki_com'):
        ...
        msg = '\U0001f7e5 Комуна\n' \
              ...
              '\n\nІнфраструктура:\n' \
              'Воєнкомат - можливість купити АК-47 або безкоштовно отримати за охорону.\n' \
              'Гулаг - за покидання клану сила двох русаків зменшиться на 20%. За роботу буде шанс отримати додаткове' \
              ' годування по 1% за кожну тисячу деревини, каменю, тканини і цегли.'
    if data.startswith('wiki_coa'):
        ...
        msg = '\U0001f7e6 Коаліція\n' \
              ...
              '\n\nІнфраструктура:\n' \
              'Штаб тероборони - можливість купувати тактичний шолом. Зменшує ефективність ворожих рейдів на 33%.\n' \
              ...
              '\U0001f7e6 Орден\n' \
              'Можливість для лідера купляти РПГ-7 за кланові гроші і рускій рух, а для заступників - ' \
    ...
    if data.startswith('wiki_aso'):
        ...
        msg = '\U0001f7e9 Асоціація\n' \
              ...
              '\U0001f7e9 Ліга\n' \
              'Якщо під час рейду що ціль має більше ресурсів - рейдери вкрадуть вдвічі більше. Можливість грабувати' \
              ' гумконвой без танкістів. В такому випадку, шанс активувати цей режим - 20%.' \
              '\n\nІнфраструктура:\n' \
              'Готель - максимальна кількість учасників збільшується до 10. Можливість вступати в клан в будь-який ' \
              'момент (не треба чекати тиждень після вступу в попередній клан).\n' \
    ...
    if data.startswith('wiki_org'):
        ...
        msg = '\U0001f7e8 Організація\n' \
              ...
              'за кожну тисячу гривень у скарбниці.' \
              '\n\nІнфраструктура:\n' \
              'Торговий центр - можливість купити Цукор для себе та Кавун базований для всього клану.\n' \
    ...
    if data.startswith('wiki_grow_feed'):
        ...
        msg = '\U0001F4C8 Розвиток\n\nУ русака є дві основні характеристики - \U0001F4AA сила та \U0001F9E0 інтелект.' \
              ...
              'зменшитись на 20%, а якщо більше 4000 - 40%. Також є 20% шанс шо русак захваоріє і нічо не зміниться.' \
              '\nЗ шансом 30% годування збільшить \U0001F54A бойовий дух на 1000, а з шансом 5% - до максимуму(10000)' \
    ...
    if data.startswith('wiki_pack'):
        ...
        msg = 'Предмети в пакунках і шанси випадіння:\n\n' \
              ...
              '\U0001f7e1 РПГ-7 - 0.45%\n' \
              '\U0001f7e1 Бронежилет - 0.45%\n' \
    ...
    if data.startswith('wiki_achieve'):
        ...
        msg = 'Досягнення і як їх отримати:\n\n' \
              ...
              '\U0001f535 Гордо і достойно ти живеш свій вік - набрати 1000 сили\n' \
