...
async def classes(message):
    msg = 'Класи русаків:\n\n\n' \
          ...
          'Офіцер \U0001F396 - платний клас з платними покращеннями. Вибір офіцера коштує \U0001F4B5 500 грн.' \
          ' Збільшує силу в дуелях на 30% (заміть 10%), якщо більше ніж 90 здоров`я. 2% шанс збільшити інтелект на 1 ' \
          'у міжчатовій битві.\n\n\n'\
...
async def classes_2(message):
    msg = 'Класи русаків:\n\n\n' \
          ...
          'Воєнний злочинець \U0001F4B5\U0001F4B5 - \U0001F3C5 40 трофеїв. Якщо русак такого класу в міжчатовій битві' \
...
async def classes_3(message):
    msg = 'Класи русаків:\n\n\n' \
          ...
          'Генерал \U0001F4B5\U0001F4B5\U0001F4B5 - \U0001F31F 1 погон. Здібність залежить від клану. Комуна - 20% ' \
