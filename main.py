...
async def classes(message):
    msg = 'Класи русаків:\n\n\n' \
          ...
          '<code>Гарматне м`ясо</code> \U0001fa96 - +50% сили в бою, якщо є АК-47 (зброя, яку можна придбати в ' \
          ...
          '\U0001F4B5 500 грн. Збільшує силу в дуелях на 40% (замість 10%), якщо більше ніж 90 здоров`я. 2% шанс збільшити ' \
...
async def classes_2(message):
    msg = 'Класи русаків:\n\n\n' \
          ...
          '<code>Орк</code> \U0001fa96\U0001fa96 - додає +2.5% сили на бій за кожне з`їдене немовля ' \
          '(максимум 50%).\n\n' \
...
async def classes_3(message):
    msg = 'Класи русаків:\n\n\n' \
          ...
          '<code>Герой Новоросії</code> \U0001fa96\U0001fa96\U0001fa96 - якщо більше ніж 300 сили: ' \
          ...
          ' Комуна - 20% шанс отримати секретні коди при роботі. Коаліція - додатковий рускій дух за перемогу.' \
          ' Асоціація - при охороні - збільшує силу гумконвою на 500000. Організація - збільшує грошову нагороду ' \
          'у міжчатових битвах до 9.\n\n\n' \
